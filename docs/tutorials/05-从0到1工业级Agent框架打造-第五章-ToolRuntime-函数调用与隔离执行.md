...
[核心代码文件](../../tests/__init__.py)

```python
"""Tests package marker for absolute imports."""
```

文件：`tests/unit/__init__.py`
...
New-Item -ItemType File -Force "tests\unit\__init__.py" | Out-Null
```

[核心代码文件](../../tests/unit/__init__.py)
...
```powershell
New-Item -ItemType Directory -Force "tests\unit" | Out-Null
New-Item -ItemType File -Force "tests\unit\conftest.py" | Out-Null
```

[核心代码文件](../../tests/unit/conftest.py)
...
文件：`tests/unit/test_tool_runtime.py`
...
```powershell
New-Item -ItemType Directory -Force "tests\unit" | Out-Null
New-Item -ItemType File -Force "tests\unit\test_tool_runtime.py" | Out-Null
```

[核心代码文件](../../tests/unit/test_tool_runtime.py)
